        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    finish();
                    Intent moveToHome = new Intent(Profile.this, HomePage.class);
    ...
    private void saveUserProfile() {
        ...
        if( !TextUtils.isEmpty(username) && !TextUtils.isEmpty(userStatus))
        {
            ...
            }else
            {
                ...
                Toast.makeText(Profile.this, "Please select the profile pic", Toast.LENGTH_LONG).show();
        ...
        }else
        {
            ...
            Toast.makeText(Profile.this, "Please enter username and status", Toast.LENGTH_LONG).show();
